...
class PongGame:
    def __init__(self, master, name_player_1='Player 1', name_player_2='Player 2'):
        ...
        master.wm_title('Игра с счётем (два игрока)')
    ...
    #         file.write(f"{self.name2}: {self.score_player_2}\n")
    #         file.write("\n")
    
    #     print(self.name1, self.score_player_1)
    #     print(self.name2, self.score_player_2)
    ...
    def move_ball(self):
        ...
        # print('Скорость маяча по оси x', self.ball_speed_x)
        # print('Скорость маяча по оси y', self.ball_speed_y)
